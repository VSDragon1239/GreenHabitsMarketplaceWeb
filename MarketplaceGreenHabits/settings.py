"""
Django settings for MarketplaceGreenHabits project.
...
hosts = os.getenv(
    'DJANGO_ALLOWED_HOSTS',
    'localhost,127.0.0.1,[::1],194.87.214.67,192.168.100.196,10.0.2.2,10.23.120.101,greenhabits.site,www.greenhabits.site',
)
...
ROOT_URLCONF = 'MarketplaceGreenHabits.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.system.context_processors.user_notifications',
...
WSGI_APPLICATION = 'MarketplaceGreenHabits.wsgi.application'
